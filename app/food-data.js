...
export const FOOD_CATEGORIES = {
  "Mughlai Cuisine": {
    "chicken seekh kebab (2 pcs)": { calories: 220, protein: 18, carbs: 4, fats: 14 },
    "mutton seekh kebab (2 pcs)": { calories: 260, protein: 16, carbs: 4, fats: 20 },
    "chicken reshmi kebab (2 pcs)": { calories: 210, protein: 20, carbs: 3, fats: 12 },
    "chicken malai tikka (4 pcs)": { calories: 320, protein: 28, carbs: 4, fats: 20 },
    "murgh musallam (1 serving)": { calories: 450, protein: 32, carbs: 8, fats: 32 },
    "mutton rogan josh (1 bowl)": { calories: 420, protein: 22, carbs: 8, fats: 32 },
    "chicken korma (1 bowl)": { calories: 400, protein: 20, carbs: 10, fats: 30 },
    "mutton korma (1 bowl)": { calories: 480, protein: 22, carbs: 10, fats: 38 },
    "nihari (1 bowl)": { calories: 350, protein: 18, carbs: 6, fats: 26 },
    "chicken changezi (1 bowl)": { calories: 390, protein: 22, carbs: 8, fats: 28 },
    "shami kebab (2 pcs)": { calories: 180, protein: 12, carbs: 8, fats: 10 },
    "galouti kebab (2 pcs)": { calories: 200, protein: 10, carbs: 6, fats: 16 },
    "mutton biryani (mughlai, 1 bowl)": { calories: 600, protein: 28, carbs: 55, fats: 28 },
    "chicken biryani (mughlai, 1 bowl)": { calories: 520, protein: 26, carbs: 55, fats: 20 },
  ...
  "Dry Fruits & Nuts": {
    ...
    "apricots dried (2 pcs)": { calories: 34, protein: 0.5, carbs: 8, fats: 0.1 },
